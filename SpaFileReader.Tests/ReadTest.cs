...
namespace SpaFileReader.Tests
{
    public class ReadTest
    {
        ...
        public async void Test1()
        {
            ...
            Assert.Equal("Bkg Tue Jan 28 09:15:50 2020 (GMT+01:00)", spa.Title);
            Assert.Equal(new DateTime(2020, 01, 28, 8, 15, 50, DateTimeKind.Utc), spa.DateTime);
        }
        ...
        public async void Test2() {
            ...
            var spa = memoryStream.ReadSpa();
            Assert.Equal("**2020-08-20_11-38-05", spa.Title);
            Assert.Equal(new DateTime(2020, 08, 20, 11, 38, 38, DateTimeKind.Utc), spa.DateTime);
        }
